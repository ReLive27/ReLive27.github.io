...
和以往文章一样，指定OAuth2客户端信息，并将OAuth2客户端信息存储在内存中，如果你需要配置数据库存储，请参考文章[将JWT与Spring Security OAuth2结合使用](https://relive27.github.io/2022/06/26/spring-security-oauth2-jwt/) 。
