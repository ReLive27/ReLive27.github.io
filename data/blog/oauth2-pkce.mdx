...
其余配置我这里就不一一说明，可以参考[之前文章](https://relive27.github.io/2022/06/26/spring-security-oauth2-jwt/)。
...
通过application.yml配置资源服务器服务端口8070，并指定授权服务器jwk uri，用于获取公钥信息验证token令牌：
