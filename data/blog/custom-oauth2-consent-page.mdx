...
[前文](https://relive27.github.io/2022/06/26/spring-security-oauth2-jwt/)我们已经简单的介绍了如何搭建授权服务器，下面将继续介绍如何自定义OAuth2授权同意页面。
...
其余配置将不再赘述，可以参考之前[将JWT与Spring Security OAuth2结合使用](https://relive27.github.io/2022/06/26/spring-security-oauth2-jwt/)文章。
